...
class TwitterClient(object):
    ...
    def __init__(self,Consumer_key = 'w9G7yqJXhkfhaBRlLhnSHMQET'
    ...
    def get_tweets(self, query,lat,log,radius,since,until,count=10):
        ...
        if lat is not None and log is not None and radius is not None:
        ...
        try:
            ...
            fetched_tweets = tweepy.Cursor(self.api.search, q=query,lang='en',since=since,until=until,geocode=geo).items(count)
