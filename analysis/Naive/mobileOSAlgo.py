...
dataset = pd.read_csv(r"C:/Users/Siddiq/Desktop/mobile_os.csv")
...
import pickle
with open('Mobile_osclassifier.pickle','wb') as f:
...
with open('Mobile_ostfidfVectorizerModel.pickle','wb') as f:
    pickle.dump(TfVec,f)