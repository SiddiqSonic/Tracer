...
dataset = pd.read_csv(r"C:/Users/Siddiq/Desktop/mobile_camera.csv")
...
import pickle
with open('Mobile_Cameraclassifier.pickle','wb') as f:
...
with open('Mobile_CameratfidfVectorizerModel.pickle','wb') as f:
    pickle.dump(TfVec,f)