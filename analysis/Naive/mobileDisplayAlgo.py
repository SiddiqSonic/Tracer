...
dataset = pd.read_csv(r"C:/Users/Siddiq/Desktop/mobile_display.csv")
...
import pickle
with open('Mobile_Displayclassifier.pickle','wb') as f:
...
with open('Mobile_DisplaytfidfVectorizerModel.pickle','wb') as f:
    pickle.dump(TfVec,f)